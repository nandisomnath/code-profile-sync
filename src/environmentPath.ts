...
export function osTypeFromString(osName: string): OsType {
  const capitalized: string = osName.toUpperCase();
  return OsType[capitalized as keyof typeof OsType];
}
...
export class Environment {
  ...
  public USER_FOLDER: string | null = null;

  public CODE_BIN?: string;

  public EXTENSION_FOLDER: string | null = null;
  public PATH: string | null | undefined = null;
  public OsType: OsType| null = null;

  public FILE_SETTING: string | null = null;
  public FILE_LAUNCH: string | null = null;
  public FILE_KEYBINDING: string | null = null;
  public FILE_LOCALE: string | null = null;
  public FILE_EXTENSION: string | null = null;
  public FILE_CLOUDSETTINGS: string | null = null;
  public FILE_SYNC_LOCK: string | null = null;

  public FILE_CUSTOMIZEDSETTINGS_NAME: string = "syncLocalSettings.json";
  public FILE_CUSTOMIZEDSETTINGS: string | null = null;
  ...
  public FOLDER_SNIPPETS: string | null = null;
  ...
  constructor() {
    ...
    if (!this.isPortable) {
      this.PATH = resolve(state.context?.globalStorageUri.toString()!, "../../..").concat(
        normalize("/")
      );
